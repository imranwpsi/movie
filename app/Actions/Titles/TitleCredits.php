            ...
            if ($title) {
                $q->orWhere(
                    fn($q) => $q
                        ...
                        ->where('creditables.creditable_type', $title->getMorphClass()),
                );
            }
            ...
            if ($episode) {
                $q->orWhere(
                    fn($q) => $q
                        ...
                        ->where('creditables.creditable_type', $episode->getMorphClass()),
                );
            }
            ...
            if ($season) {
                $q->orWhere(
                    fn($q) => $q
                        ...
                        ->where('creditables.creditable_type', $season->getMorphClass()),
                );
            }
        });

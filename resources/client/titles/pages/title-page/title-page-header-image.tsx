...
export function TitlePageHeaderImage({title, season, episode}: Props) {
  ...
  return (
    <header className="relative isolate h-160 overflow-hidden bg-black md:h-280 lg:h-450">
      <div className="container absolute left-0 right-0 top-0 z-20 mx-auto h-full w-full px-24">
        {backdrop}
      </div>
      ...
      <div className="pointer-events-none absolute left-0 top-0 z-30 h-full w-full bg-gradient-to-b from-black/70" />

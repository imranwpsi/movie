...
import { u as useCancelSubscription, a as useResumeSubscription } from "./use-resume-subscription-a881484a.mjs";
...
const IconList = React.lazy(() => import("./icon-list-ad9040d8.mjs"));
...
function AppearanceForm({ defaultValues }) {
  ...
  return /* @__PURE__ */ jsxs(
    Form$1,
    {
      ...
      children: [
        /* @__PURE__ */ jsx(Header$4, { isLoading: saveChanges.isLoading }),
...
const AceEditor = React.lazy(() => import("./ace-editor-c91d08fd.mjs"));
function AceDialog({
  defaultValue,
  mode = "html",
  title,
...
function useImportSearchModels() {
  const { trans } = useTrans();
  return useMutation((payload) => importModels(payload), {
    onSuccess: () => {
      ...
      actions: /* @__PURE__ */ jsxs("div", { className: "pt-14 mt-10 border-t", children: [
        ...
        /* @__PURE__ */ jsx(
          Button,
          {
            ...
            disabled: importModels2.isLoading,
            onClick: () => {
...
function useRole() {
  ...
  return useQuery([Endpoint$6(roleId)], () => fetchRole(roleId));
}
...
function useUpdateRole() {
  ...
  return useMutation((payload) => updateRole(payload), {
    onSuccess: (response) => {
      ...
      queryClient.invalidateQueries([Endpoint$5(response.role.id)]);
...
function useCreateNewTag(form) {
  const { trans } = useTrans();
  return useMutation((props) => createNewTag$1(props), {
    onSuccess: () => {
...
function useUpdateTag(form) {
  const { trans } = useTrans();
  return useMutation((props) => updateTag$1(props), {
    onSuccess: () => {
...
function useCreateSubscription(form) {
  ...
  return useMutation((props) => createNewSubscription(props), {
    onSuccess: () => {
      ...
      queryClient.invalidateQueries(DatatableDataQueryKey(endpoint$5));
    },
    onError: (err) => onFormQueryError(err, form)
  });
}
...
function SuspendSubscriptionButton({ subscription }) {
  ...
  const handleSuspendSubscription = () => {
    cancelSubscription.mutate(
      ...
      {
        onSuccess: () => {
          queryClient.invalidateQueries(DatatableDataQueryKey(endpoint$4));
        }
      }
    );
  };
...
function useProduct() {
  ...
  return useQuery([Endpoint$3(productId)], () => fetchProduct(productId));
}
  ...
  return useMutation(
    (payload) => updateProduct(payload),
    {
      onSuccess: (response) => {
        ...
        queryClient.invalidateQueries([Endpoint$2(response.product.id)]);
        queryClient.invalidateQueries(
  ...
  return useMutation(
    (payload) => createProduct(payload),
    {
      onSuccess: () => {
        ...
        queryClient.invalidateQueries([endpoint$2]);
        queryClient.invalidateQueries(
          DatatableDataQueryKey("billing/products")
        );
        navigate("/admin/plans");
...
function useResetChannelsToDefault() {
  const { trans } = useTrans();
  return useMutation(() => resetChannels(), {
    onSuccess: async () => {
...
function ResetChannelsDialog() {
  ...
  return /* @__PURE__ */ jsx(
    ConfirmationDialog,
    {
      isLoading: resetChannels2.isLoading,
      onConfirm: () => {
...
function PageContent$3({ channel, children }) {
  ...
  return /* @__PURE__ */ jsx(
    CrupdateResourceLayout,
    {
      ...
      isLoading: updateChannel2.isLoading,
      children
    }
  );
}
...
function useCreateChannel(form) {
  ...
  const queryClient2 = useQueryClient();
  return useMutation(
    (payload) => createChannel(payload),
    {
      onSuccess: async (response) => {
        await queryClient2.invalidateQueries(DatatableDataQueryKey(endpoint$1));
...
function CreateChannelPageLayout({ defaultValues, children }) {
  ...
  return /* @__PURE__ */ jsx(
    CrupdateResourceLayout,
    {
      ...
      isLoading: createChannel2.isLoading,
      children
    }
  );
}
...
function useDeleteNewsArticle() {
  return useMutation((payload) => deleteArticle(payload), {
    onError: (err) => showHttpErrorToast(err),
    onSuccess: async () => {
      await queryClient.invalidateQueries(DatatableDataQueryKey("news"));
...
function DeleteArticleDialog({ article }) {
  ...
  return /* @__PURE__ */ jsx(
    ...
    {
      isDanger: true,
      isLoading: deleteArticle2.isLoading,
...
function useImportNewsArticles() {
  return useMutation(() => importArticles(), {
    onSuccess: async () => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(Tooltip, { label: /* @__PURE__ */ jsx(Trans, { message: "Import news articles" }), children: /* @__PURE__ */ jsx(
      IconButton,
      {
        ...
        disabled: importArticles2.isLoading,
...
function useUpdateComment() {
  return useMutation((props) => updateComment(props), {
    onSuccess: () => {
...
function useRestoreComments() {
  return useMutation((payload) => restoreComment(payload), {
    onSuccess: (response, payload) => {
      toast(
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(
          Button,
          {
            ...
            type: "submit",
            className: "mr-6",
            disabled: updateComment2.isLoading,
...
function CommentsDatatablePage({ hideTitle, commentable }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: clsx(!hideTitle && "p-12 md:p-24"), children: [
    ...
    /* @__PURE__ */ jsxs("div", { children: [
      ...
      (query.isFetched || query.isPreviousData) && !(pagination == null ? void 0 : pagination.data.length) ? /* @__PURE__ */ jsx(
        DataTableEmptyStateMessage,
        {
          className: "pt-50",
          isFiltering,
      ...
      children: [
        /* @__PURE__ */ jsx(
          Button,
          {
            ...
            color: "danger",
            className: "mr-10",
            disabled: deleteReviews.isLoading,
            children: /* @__PURE__ */ jsx(Trans, { message: "Delete" })
          }
        ),
        /* @__PURE__ */ jsx(
...
function useUpdateReview(review, form) {
  return useMutation(
    (payload) => updateReview(review, payload),
    {
      onSuccess: () => {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(
          Button,
          {
            ...
            type: "submit",
            className: "mr-6",
            disabled: updateReview2.isLoading,
            children: /* @__PURE__ */ jsx(Trans, { message: "Save" })
          }
        ),
        /* @__PURE__ */ jsx(
...
function useTitlesAutocomplete(params) {
  return useQuery(
    ["titles", "autocomplete", params],
    () => autocompleteTitles(params),
...
function TitleSelect({
  ...
  const isLoading = query.isLoading || query.isPreviousData;
...
function useCreateVideo(form) {
  return useMutation((payload) => createVideo(payload), {
    onSuccess: async () => {
...
function CreateVideoPage({ children }) {
  ...
  return /* @__PURE__ */ jsxs(
    CrupdateResourceLayout,
    {
      ...
      isLoading: createVideo2.isLoading,
...
function useUpdateVideo(form) {
  ...
  return useMutation(
    (payload) => updateVideo(videoId, payload),
    {
      onSuccess: async () => {
        await queryClient.invalidateQueries(["video"]);
      },
...
function useVideo() {
  const { videoId } = useParams();
  return useQuery(["video", `${videoId}`], () => fetchVideo(videoId));
}
...
function EditVideoPage() {
  ...
  return /* @__PURE__ */ jsx(
    CrupdateResourceLayout,
    {
      ...
      isLoading: query.isLoading || updateVideo2.isLoading,
      disableSaveWhenNotDirty: true,
...
function useDeleteEpisode(episode) {
  return useMutation(() => deleteEpisode(episode.id), {
    onSuccess: async () => {
      await queryClient.invalidateQueries(
        seasonQueryKey(episode.title_id, episode.season_number)
      );
...
function DeleteEpisodeDialog({ episode }) {
  ...
  return /* @__PURE__ */ jsx(
    ConfirmationDialog,
    {
      isLoading: deleteEpisode2.isLoading,
      isDanger: true,
...
function useDeleteSeason(title, seasonId) {
  return useMutation(() => deleteSeason(seasonId), {
    onSuccess: async () => {
      await queryClient.invalidateQueries(titleSeasonsQueryKey(title.id));
...
function TitleSeasonsEditor() {
    ...
    content = query.items.length ? /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsx(
        Button,
        {
          ...
          color: "primary",
          startIcon: /* @__PURE__ */ jsx(AddIcon, {}),
          disabled: createSeason2.isLoading,
  ...
  return /* @__PURE__ */ jsx(TitleEditorLayout, { children: content });
}
...
function useCreateTitle(form) {
  return useMutation((payload) => createTitle(payload), {
    onSuccess: async () => {
      await queryClient.invalidateQueries(["titles"]);
    },
    onError: (r) => form ? onFormQueryError(r, form) : showHttpErrorToast(r)
  });
}
...
function useUpdateTitle(form) {
  const { titleId } = useParams();
  return useMutation(
    (payload) => updateTitle$1(titleId, payload),
    {
      onSuccess: async () => {
        await queryClient.invalidateQueries(["titles"]);
      },
        ...
        TitleEditorLayout,
        {
          actions: /* @__PURE__ */ jsx(
            Button,
            {
              ...
              color: "primary",
              type: "submit",
              disabled: createTitle2.isLoading || !isDirty,
        ...
        TitleEditorLayout,
        {
          actions: /* @__PURE__ */ jsx(
            Button,
            {
              ...
              color: "primary",
              type: "submit",
              disabled: updateTitle2.isLoading || !form.formState.isDirty,
              children: /* @__PURE__ */ jsx(Trans, { message: "Save" })
            }
          ),
          children: /* @__PURE__ */ jsx(FormFields$1, {})
...
function FormFields$1() {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mb-24 items-center gap-24 md:flex", children: [
      ...
      /* @__PURE__ */ jsx(CertificationSelect, {})
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "mb-24 items-center gap-24 md:flex", children: [
      /* @__PURE__ */ jsx(
        FormTextField,
...
function useDeleteImage(imageId) {
  const { titleId } = useParams();
  return useMutation(() => deleteImage(imageId), {
    onSuccess: async () => {
      await queryClient.invalidateQueries(["titles", `${titleId}`]);
...
function useUploadImage() {
  const { titleId } = useParams();
  return useMutation((payload) => uploadImage(payload), {
    onSuccess: async () => {
      await queryClient.invalidateQueries(["titles", `${titleId}`]);
...
function UploadButton() {
  ...
  return /* @__PURE__ */ jsx(
    Button,
    {
      ...
      color: "primary",
      startIcon: /* @__PURE__ */ jsx(AddIcon, {}),
      disabled: uploadImage2.isLoading,
...
function DeleteButton$3({ imageId }) {
  ...
  return /* @__PURE__ */ jsx(
    Button,
    {
      variant: "outline",
      size: "xs",
      disabled: deleteImage2.isLoading,
...
function useDeleteVideos() {
  return useMutation((payload) => deleteVideos(payload), {
    onSuccess: async () => {
      await queryClient.invalidateQueries(["video"]);
    },
    onError: (r) => showHttpErrorToast(r)
      ...
      children: [
        /* @__PURE__ */ jsx(
          Button,
          {
            ...
            size: "xs",
            startIcon: /* @__PURE__ */ jsx(DeleteIcon, {}),
            disabled: deleteVideos2.isLoading,
            children: /* @__PURE__ */ jsx(Trans, { message: "Delete" })
          }
        ),
        /* @__PURE__ */ jsx(
...
function useUpdateEpisode(titleId, season, episode, form) {
  return useMutation(
    (payload) => updateEpisode(titleId, season, episode, payload),
    {
      onSuccess: async ({ episode: episode2 }) => {
        await queryClient.invalidateQueries(
          seasonQueryKey(episode2.title_id, episode2.season_number)
        );
      },
      onError: (r) => onFormQueryError(r, form)
    }
...
function useCreateEpisode(form, titleId, season) {
  return useMutation(
    (payload) => createEpisode(titleId, season, payload),
    {
      onSuccess: async () => {
        await queryClient.invalidateQueries(seasonQueryKey(titleId, season));
      },
      onError: (r) => form ? onFormQueryError(r, form) : showHttpErrorToast(r)
    }
  );
        ...
        EpisodeEditorLayout,
        {
          actions: /* @__PURE__ */ jsx(
            Button,
            {
              ...
              color: "primary",
              type: "submit",
              disabled: createEpisode2.isLoading || !isDirty,
              children: /* @__PURE__ */ jsx(Trans, { message: "Save" })
            }
          ),
        ...
        EpisodeEditorLayout,
        {
          actions: /* @__PURE__ */ jsx(
            Button,
            {
              ...
              color: "primary",
              type: "submit",
              disabled: updateEpisode2.isLoading || !form.formState.isDirty,
              children: /* @__PURE__ */ jsx(Trans, { message: "Save" })
            }
          ),
          children: /* @__PURE__ */ jsx(FormFields, {})
...
function useSortTitleCredits() {
  const { titleId } = useParams();
  return useMutation((payload) => sortCredits(payload), {
    onSuccess: async () => {
      await queryClient.invalidateQueries(titleCreditsQueryKey(titleId));
...
function useUpdateTitleCredit(form, creditId) {
  const { titleId, season, episode } = useParams();
  return useMutation(
    (payload) => updateTitle(titleId, season, episode, creditId, payload),
    {
      onSuccess: async () => {
        await queryClient.invalidateQueries(titleCreditsQueryKey(titleId));
...
function useCreateTitleCredit(form) {
  const { titleId, season, episode } = useParams();
  return useMutation(
    (payload) => createCredit(titleId, season, episode, payload),
    {
      onSuccess: async () => {
        await queryClient.invalidateQueries(titleCreditsQueryKey(titleId));
        toast(message("Credit added"));
    ...
    /* @__PURE__ */ jsxs(DialogFooter, { children: [
      ...
      /* @__PURE__ */ jsx(
        Button,
        {
          ...
          variant: "flat",
          color: "primary",
          disabled: createCredit2.isLoading,
          children: /* @__PURE__ */ jsx(Trans, { message: "Create" })
        }
      )
    ] })
...
function useDeleteTitleCredit(creditId) {
  const { titleId, season, episode } = useParams();
  return useMutation(() => deleteCredit$1(titleId, season, episode, creditId), {
    onSuccess: async () => {
      await queryClient.invalidateQueries(titleCreditsQueryKey(titleId));
...
function useDetachTitleTag(tag) {
  const { titleId } = useParams();
  return useMutation(() => detachTag(titleId, tag), {
    onSuccess: async () => {
      await queryClient.invalidateQueries(["titles", `${titleId}`]);
...
function useAttachTitleTag(form, tagType) {
  const { titleId } = useParams();
  return useMutation(
    (payload) => attachTag(titleId, tagType, payload),
    {
      onSuccess: async () => {
        await queryClient.invalidateQueries(["titles", `${titleId}`]);
...
function DetachTagDialog({ tag }) {
  ...
  return /* @__PURE__ */ jsx(
    ConfirmationDialog,
    {
      isLoading: detachTag2.isLoading,
      isDanger: true,
...
function useCreatePerson(form) {
  return useMutation((payload) => createPerson(payload), {
    onSuccess: async () => {
      await queryClient.invalidateQueries(["people"]);
...
function CreatePersonPage() {
  ...
  return /* @__PURE__ */ jsx(
    CrupdateResourceLayout,
    {
      ...
      isLoading: createPerson2.isLoading,
      disableSaveWhenNotDirty: true,
...
function useUpdatePerson(form) {
  ...
  return useMutation(
    (payload) => updatePerson(payload, personId),
    {
      onSuccess: async () => {
        await queryClient.invalidateQueries(["people", `${personId}`]);
...
function useDeletePersonCredit(credit) {
  const { personId } = useParams();
  return useMutation(
    () => deleteCredit(credit.id, void 0, void 0, credit.pivot.id),
    {
      onSuccess: async () => {
        await queryClient.invalidateQueries(titleCreditsQueryKey(credit.id));
        await queryClient.invalidateQueries(["people", `${personId}`]);
        toast(message("Credit deleted"));
      },
      onError: (r) => showHttpErrorToast(r)
  ...
  return /* @__PURE__ */ jsxs(DialogTrigger, { type: "modal", children: [
    ...
    /* @__PURE__ */ jsx(
      ConfirmationDialog,
      {
        ...
        body: /* @__PURE__ */ jsx(Trans, { message: "Are you sure you want to delete this credit?" }),
        confirm: /* @__PURE__ */ jsx(Trans, { message: "Delete" }),
        isLoading: deleteCredit2.isLoading,
...
function useUpdateNewsArticle() {
  ...
  return useMutation(
    (payload) => updateArticle(articleId, payload),
    {
      onError: (err) => showHttpErrorToast(err),
      onSuccess: async () => {
        await queryClient.invalidateQueries(["news"]);
  ...
  return /* @__PURE__ */ jsx(Suspense, { fallback: /* @__PURE__ */ jsx(FullPageLoader, {}), children: /* @__PURE__ */ jsx(ArticleBodyEditor$3, { initialContent: article.body, children: (content, editor) => /* @__PURE__ */ jsx(FileUploadProvider, { children: /* @__PURE__ */ jsxs(FormProvider, { ...form, children: [
    /* @__PURE__ */ jsx(
      ArticleEditorStickyHeader,
      {
        editor,
        backLink: "../..",
        isLoading: updateArticle2.isLoading,
        onSave: handleSave
      }
    ),
  ...
  return /* @__PURE__ */ jsx(Suspense, { fallback: /* @__PURE__ */ jsx(FullPageLoader, {}), children: /* @__PURE__ */ jsx(ArticleBodyEditor$2, { children: (content, editor) => /* @__PURE__ */ jsx(FileUploadProvider, { children: /* @__PURE__ */ jsxs(FormProvider, { ...form, children: [
    /* @__PURE__ */ jsx(
      ArticleEditorStickyHeader,
      {
        editor,
        backLink: "..",
        isLoading: createArticle2.isLoading,
        onSave: handleSave
      }
    ),
    /* @__PURE__ */ jsxs("div", { className: "mx-20", children: [
...
function useCreateTitleTag(form, type) {
  return useMutation(
    (props) => createNewTag(props, type),
    {
      onSuccess: async () => {
        await queryClient.invalidateQueries(
          DatatableDataQueryKey("title-tags")
        );
      },
      onError: (err) => onFormQueryError(err, form)
    }
...
const ReportsPage = React.lazy(() => import("./admin-report-page-a861d54f.mjs"));
...
export {
  ...
  RedoIcon as v,
  RestartAltIcon as w,
  SmartDisplayIcon as x,
  SubtitlesIcon as y,
  SyncIcon as z
};
//# sourceMappingURL=admin-routes-79a5a97e.mjs.map

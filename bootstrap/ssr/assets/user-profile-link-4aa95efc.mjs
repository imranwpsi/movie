  ...
  return useQuery(
    ...
    () => fetchChannel(channelId, { ...queryParams, loader }),
    {
      initialData: () => {
        ...
        if ((data == null ? void 0 : data.channel.id) == channelId || (data == null ? void 0 : data.channel.slug) == channelId) {
          return data;
        }
      }
    }
...
function useUpdateChannelContent(channelId) {
  const { trans } = useTrans();
  return useMutation((payload) => updateChannel(channelId, payload), {
    onSuccess: () => {
...
function UpdateContentButton() {
  ...
  return /* @__PURE__ */ jsx(
    Button,
    {
      ...
      disabled: updateContent.isLoading || !watch("config.autoUpdateMethod") || !watch("id"),
...
function useDeleteComments() {
  return useMutation((payload) => deleteComments(payload), {
...
function useInfiniteData(props) {
  ...
  return {
    ...
    isReloading: query.isFetching && !query.isFetchingNextPage && query.isPreviousData,
    sortDescriptor,
    setSortDescriptor,
    searchQuery,
    setSearchQuery
...
function useDeleteReviews() {
  return useMutation((payload) => deleteReviews(payload), {
    onSuccess: async () => {
...
IS_CLIENT ? (_c = window.navigator) == null ? void 0 : _c.userAgent.toLowerCase() : "";
...
const HlsProvider = React.lazy(
  () => import("./hls-provider-46fcbb31.mjs")
);
const DashProvider = React.lazy(
  () => import("./dash-provider-1d3c303f.mjs")
);
...
function ToggleMuteButton({ color }) {
...
function PlaybackOptionsButton({
  ...
  return /* @__PURE__ */ jsxs(DialogTrigger, { type: "popover", placement: "top-end", usePortal: false, children: [
    /* @__PURE__ */ jsx(
      IconButton,
      {
        color,
...
function useCreateReview(form) {
  return useMutation((payload) => createReview(payload), {
    onSuccess: async () => {
      await queryClient.invalidateQueries(reviewsQueryKey());
    },
      ...
      /* @__PURE__ */ jsxs("div", { className: "pb-16", children: [
        ...
        /* @__PURE__ */ jsx(
          Button,
          {
            ...
            color: "primary",
            className: "w-full",
            disabled: !currentRating || createReview2.isLoading,
...
function useCurrentUserRatings() {
  const { user } = useAuth();
  return useQuery(["reviews", "users", `${user == null ? void 0 : user.id}`], () => fetchRatings(), {
    enabled: !!user
  });
}
...
function EpisodeRating({ title, episode, allowRating }) {
  if (episode.status === "upcoming") {
    return /* @__PURE__ */ jsx(FormattedDate, { date: episode.release_date });
  }
...
function VideoGridItemBottomGradient() {
  return /* @__PURE__ */ jsx("div", { className: "player-bottom-gradient pointer-events-none absolute bottom-0 z-20 h-full w-full bg-bottom bg-repeat-x pt-36" });
}
...
function useCreateList(form) {
  const { trans } = useTrans();
  const navigate = useNavigate$1();
  return useMutation((payload) => createList$1(payload), {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx(
      CrupdateResourceLayout,
      {
        ...
        isLoading: createList2.isLoading,
...
function useUpdateList(form) {
  ...
  const navigate = useNavigate$1();
  return useMutation(
    (payload) => createList(payload, slugOrId),
    {
      onSuccess: async () => {
        await queryClient.invalidateQueries(DatatableDataQueryKey("channel"));
...
//# sourceMappingURL=user-profile-link-4aa95efc.mjs.map

...
import { hashQueryKey, useQuery, useMutation, useQueryClient } from "@tanstack/react-query";
...
function useChannelContent(channel) {
  ...
  return useQuery(
    ...
    () => fetchChannelContent(channel.id, queryParams),
    {
...
function Slide({ item, index }) {
  return /* @__PURE__ */ jsxs("div", { className: "relative h-full w-full flex-shrink-0 snap-start snap-normal overflow-hidden rounded", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "absolute inset-0 isolate flex h-full w-full items-center justify-start gap-24 rounded p-30 text-white md:items-end", children: [
      /* @__PURE__ */ jsx("div", { className: "absolute left-0 h-full w-full bg-gradient-to-b from-black/100 max-md:top-0 md:bottom-0 md:h-3/4 md:bg-gradient-to-t" }),
      /* @__PURE__ */ jsx(
        TitlePoster,
        {
          title: item,
      ...
      /* @__PURE__ */ jsxs("div", { className: "z-10 text-lg md:max-w-620", children: [
        ...
        item.description && /* @__PURE__ */ jsx("p", { className: "max-md:hidden", children: item.description.slice(0, 200) }),
...
function ChannelContentNews({
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex gap-34", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "flex-auto", children: data == null ? void 0 : data.slice(2, 10).map((article) => /* @__PURE__ */ jsxs("div", { className: "mb-12 flex items-center gap-14", children: [
...
function search(loader, query) {
  return apiClient.get(`search/${query}`, { params: { loader } }).then((response) => response.data);
}
...
function SitePageLayout({ children }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex-auto", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "relative min-h-[1000px]", children }),
...
function ChannelPage({ slugOrId, type = "channel" }) {
  ...
  if (query.data) {
    ...
    content2 = /* @__PURE__ */ jsx(PageStatus, { query, loaderClassName: "absolute inset-0 m-auto" });
  }
...
function RelatedTitlesPanel({ title }) {
  ...
  if ((data == null ? void 0 : data.titles.length) === 0) {
    return null;
  }
  return /* @__PURE__ */ jsxs("div", { className: "mt-48", children: [
    /* @__PURE__ */ jsx(
    ...
    /* @__PURE__ */ jsx(
      "div",
      {
        ...
        children: data == null ? void 0 : data.titles.map((item) => /* @__PURE__ */ jsx("div", { className: itemClassName2, children: /* @__PURE__ */ jsx(TitlePortraitGridItem, { item }) }, item.id))
      }
    )
  ] });
}
...
function useSubmitReviewFeedback(review) {
  return useMutation((payload) => submitFeedback(payload, review), {
    onSuccess: () => {
...
function useSubmitReport(model) {
  return useMutation((payload) => submitReport(model, payload), {
    onSuccess: () => {
...
function Feedback({ review }) {
  ...
  const isDisabled = submitFeedback2.isLoading || user != null && user.id === review.user_id;
...
function ReviewList({
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsx(AnimatePresence, { initial: false, mode: "wait", children: query.isInitialLoading ? /* @__PURE__ */ jsx(ReviewListSkeletons, { count: 4 }) : /* @__PURE__ */ jsx(
        ReviewListItems,
        {
          reviews: query.items,
          sharedReview,
...
function TitlePageHeaderImage({ title, season, episode }) {
  ...
  return /* @__PURE__ */ jsxs("header", { className: "relative isolate h-160 overflow-hidden bg-black md:h-280 lg:h-450", children: [
    /* @__PURE__ */ jsx("div", { className: "container absolute left-0 right-0 top-0 z-20 mx-auto h-full w-full px-24", children: backdrop }),
    ...
    /* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute left-0 top-0 z-30 h-full w-full bg-gradient-to-b from-black/70" }),
...
function useAddToWatchlist() {
  ...
  return useMutation(
    (payload) => addToWatchlist(data.watchlist.id, payload),
    {
      onSuccess: async () => {
...
function useRemoveFromWatchlist() {
  const { data } = useCurrentUserWatchlist();
  return useMutation(
    (payload) => removeFromWatchlist(data.watchlist.id, payload),
    {
      onSuccess: async () => {
        await queryClient.invalidateQueries(["channel", "watchlist"]);
...
function WatchlistButton({
  ...
  return /* @__PURE__ */ jsx(
    Button,
    {
      ...
      disabled: addToWatchlist2.isLoading || removeFromWatchlist2.isLoading || isLoading,
      onClickCapture: authHandler,
      onClick: () => {
        if (isWatchlisted) {
  ...
  return /* @__PURE__ */ jsx(
    TitlePageHeaderLayout,
    {
      ...
      description: /* @__PURE__ */ jsxs(BulletSeparatedItems, { className: "my-10 md:my-0", children: [
        ...
        /* @__PURE__ */ jsx(FormattedDuration, { minutes: title.runtime, verbose: true })
      ] }),
...
function NewCommentForm({
  ...
  return /* @__PURE__ */ jsxs(
    "form",
    {
      ...
      onSubmit: (e) => {
        e.preventDefault();
        if (inputValue && !createComment2.isLoading) {
          ...
          inputIsExpanded && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-12 justify-end mt-12", children: [
            ...
            /* @__PURE__ */ jsx(
              Button,
              {
                ...
                color: "primary",
                type: "submit",
                disabled: createComment2.isLoading || inputValue.length < 3,
...
function useStoreVote(model) {
  return useMutation((payload) => changeVote(model, payload), {
    onSuccess: (response) => {
    },
    onError: (err) => showHttpErrorToast(err)
  });
  ...
  return /* @__PURE__ */ jsxs("div", { className: clsx(className2, "whitespace-nowrap"), children: [
    /* @__PURE__ */ jsxs(
      Button,
      {
        ...
        disabled: changeVote2.isLoading,
        "aria-label": "Upvote",
        onClick: () => {
          changeVote2.mutate(
            { voteType: "upvote" },
  ...
  return /* @__PURE__ */ jsxs("div", { className: "container mx-auto mt-14 items-start gap-40 px-14 md:mt-40 md:px-24 lg:flex", children: [
    /* @__PURE__ */ jsx("main", { className: "mb-24 rounded border p-16", children: /* @__PURE__ */ jsxs("div", { className: "flex-auto", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "items-start gap-16 md:flex", children: [
        ...
        /* @__PURE__ */ jsx("p", { dangerouslySetInnerHTML: { __html: article.body } })
      ] }),
...
function useDeleteList() {
  const { trans } = useTrans();
  return useMutation((payload) => deleteList(payload), {
    onSuccess: async () => {
...
function DeleteListDialog({ list }) {
  ...
  return /* @__PURE__ */ jsx(
    ConfirmationDialog,
    {
      ...
      confirm: /* @__PURE__ */ jsx(Trans, { message: "Delete" }),
      isLoading: deleteList2.isLoading,
...
function useFollowUser() {
  return useMutation((payload) => followUser(payload), {
...
function useUnfollowUser() {
  return useMutation((payload) => unfollowUser(payload), {
    onSuccess: async (response, { user }) => {
      await queryClient.invalidateQueries(["users"]);
      toast(
...
function FollowButton({ user, className: className2, ...buttonProps }) {
  ...
  if (isFollowing) {
    return /* @__PURE__ */ jsx(
      Button,
      {
        ...
        disabled: !currentUser || (currentUser == null ? void 0 : currentUser.id) === user.id || unfollowUser2.isLoading || isLoading,
  ...
  return /* @__PURE__ */ jsx(
    Button,
    {
      ...
      disabled: !currentUser || (currentUser == null ? void 0 : currentUser.id) === user.id || followUser2.isLoading || isLoading,
    ...
    /* @__PURE__ */ jsxs(DialogFooter, { children: [
      ...
      /* @__PURE__ */ jsx(
        Button,
        {
          ...
          variant: "flat",
          color: "primary",
          disabled: updateProfile2.isLoading,
...
//# sourceMappingURL=site-routes-a69003ce.mjs.map

...
const BillingPageRoutes = React.lazy(
  () => import("./assets/billing-page-routes-4ed98b6b.mjs")
);
const CheckoutRoutes = React.lazy(() => import("./assets/checkout-routes-5a64ed60.mjs"));
...
const AdminRoutes = React.lazy(() => import("./assets/admin-routes-79a5a97e.mjs").then((n) => n.X));
const SwaggerApiDocs = React.lazy(
  () => import("./assets/swagger-api-docs-page-ebf8704c.mjs")
);
const SiteRoutes = React.lazy(() => import("./assets/site-routes-a69003ce.mjs"));
function AppRoutes() {
  var _a;
...
export {
  ...
  PaymentsIcon as bE,
  PeopleIcon as bF,
  PhonelinkLockIcon as bG,
  SmartphoneIcon as bH,
  TabletIcon as bI,
  useCollator as bJ,
  elementToTree as bK,
  MovieIcon as ba,
  ...
  AddAPhotoIcon as bk,
  ApiIcon as bl,
  ArrowDropDownIcon as bm,
  CheckBoxOutlineBlankIcon as bn,
  CheckCircleIcon as bo,
  ComputerIcon as bp,
  DangerousIcon as bq,
  DarkModeIcon as br,
  DevicesIcon as bs,
